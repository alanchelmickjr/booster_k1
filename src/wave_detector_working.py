#!/usr/bin/env python3
"""
Wave detector based on working came_yolo.py pattern
Uses built-in HTTP server and proper ROS2 threading
"""
...
class WaveDetector:
    ...
    def __init__(self):
        ...
        print("YOLO model loaded for wave detection")
    ...
    def convert_nv12_to_bgr(self, msg):
        ...
        if msg.encoding == 'nv12':
            ...
            if len(img_data) != expected_size:
                self.get_logger().warning(f'Size mismatch: {len(img_data)} vs {expected_size}')
                return None
...
def main():
    ...
    print("Initializing YOLO wave detector...")
    ...
    print(f'Web interface: http://192.168.88.153:{port}')
    print('\nSystem Ready!')
    print('- Open browser to see live feed')
    print('- Wave at camera for interaction')
