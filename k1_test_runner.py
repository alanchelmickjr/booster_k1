...
class K1TestRunner:
    ...
    def test_phase3_software(self):
        ...
        test_cmd = f"""cd {ROBOT_PATH} && timeout 3 python3 src/basic_controls.py 127.0.0.1 2>&1 | head -20"""
...
" 2>&1"""
    ...
    def test_phase4_emergency_stop(self):
        ...
        test_cmd = f"""cd {ROBOT_PATH} && timeout 2 python3 src/basic_controls.py 127.0.0.1 2>&1"""
    ...
    def print_summary(self):
        ...
        if passed_tests == total_tests:
            ...
            print("   cd booster_k1")
            print("   python3 src/basic_controls.py 127.0.0.1")
